...
export const metadata: Metadata = {
  ...
  description:
    "Acoruは、現場の記録・報告・確認・集計の負担を減らし、人を増やしにくい中でも仕事が回る仕組みを整える北海道の業務改善パートナーです。",
};
        ...
        <Container>
          <div className="max-w-4xl space-y-6">
            ...
            <div className="space-y-4 text-sm leading-relaxed text-slate-700 sm:text-base">
              <p>
                Acoruは、現場の記録・報告・確認・集計の負担を減らし、人を増やしにくい中でも仕事が回りやすくなる仕組みを整える会社です。
                前に導入した仕組みが現場に合わなかった会社さまに対しても、今の仕事の流れに合わせて見直しから伴走します。
              </p>
            </div>
