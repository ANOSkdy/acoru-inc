...
export const metadata: Metadata = {
  ...
  description:
    "Acoruのサービス一覧。現場の記録・報告・確認・集計の負担を減らし、今の仕事の流れに合う仕組みを整える3つの支援を紹介します。",
};
        ...
        <Container>
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <h2 className="text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl">課題に合わせて選べる、現場起点の支援メニュー</h2>
              <p className="max-w-2xl text-sm leading-relaxed text-slate-600 sm:text-base">
                まずは1現場・1プロジェクトから始められるように、Acoruでは3つのサービスラインをご提供しています。現場の運用に合う形で、段階的に整備できます。
              </p>
            </div>
