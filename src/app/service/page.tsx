        ...
        <Container>
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <h2 className="text-xl font-semibold leading-snug tracking-tight text-slate-900 sm:text-2xl">現場の実態に合わせて、AI時代の業務基盤を整える</h2>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <Button href="/contact" className="w-full justify-center sm:w-auto">まずは業務データの整理を相談する</Button>
            </div>
          </div>
        </Container>
      </Section>
